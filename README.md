# Punto de partida para el TP 1 de Arquitectura del Software (75.73) del 1er cuatrimestre de 2021

> **La fecha de entrega para el informe y el código es el jueves 27/05** :bangbang:
...
La imagen provista por la cátedra es `arqsoft/bbox:202101.1`. Se trata de una aplicación ("bbox") que provee 2 servicios, uno con comportamiento sincrónico y otro con comportamiento asincrónico. Se configura a través del archivo `/opt/bbox/config.properties`, que ustedes deberán mapear vía un volumen a un archivo en el equipo host (caso similar a la configuración de nginx que les da la cátedra).
